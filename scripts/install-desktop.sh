#!/usr/bin/env bash
# dsh-agent-mode-switcher — one-shot installer for DeepSeek Harness Desktop
#
...
# ---- per-plugin config ------------------------------------------------------
REPO="my-dsh-plugin/agent-mode-switcher"
BRANCH="main"
PLUGIN_NAME="dsh-agent-mode-switcher"
WHITELIST_NS="agent-mode-switcher"   # settings namespace; empty => skip allowlist patch
